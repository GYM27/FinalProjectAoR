...
/**
 * Utility class responsible for formatting the observed physiological value
 * of a triggered alert into a human-readable string with the appropriate unit.
 * Example output: "98 bpm", "37.20 ºC", "95 %"
 *
 * @see com.grupo3aor.innovationlab.service.ClinicalFormatter for narrative rationale formatting
 */
@Slf4j
public class ClinicalValueFormatter {
