...
class EmailServiceTest {
    ...
    void sendConfirmationEmail_Success() {
        ...
        assertTrue(sentMessage.getText().contains("https://localhost:5173/ativar?token=token123"));
    ...
    void sendPasswordResetEmail_Success() {
        ...
        assertTrue(sentMessage.getText().contains("https://localhost:5173/reset-password?token=reset123"));
